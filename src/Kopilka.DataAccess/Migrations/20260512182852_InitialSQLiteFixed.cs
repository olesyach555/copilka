    ...
    public partial class InitialSQLiteFixed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DebtContracts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DebtContracts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinancialGoals_Users_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reminders_Categories_TransactionCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentSchedules_DebtContracts_DebtContractId",
                        column: x => x.DebtContractId,
                        principalTable: "DebtContracts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DebtContracts_UserId",
                table: "DebtContracts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialGoals_OwnerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentSchedules_DebtContractId",
                table: "PaymentSchedules",
                column: "DebtContractId");

            migrationBuilder.CreateIndex(
                name: "IX_Reminders_TransactionCategoryId",
                table: "Reminders",
