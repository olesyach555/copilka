    ...
    public partial class SeedApplicationData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 2, 5014.90m, new DateTime(2025, 11, 1), "Кофе" },
                    { 2, 2, 3, 890.00m, new DateTime(2025, 11, 2), "Такси" },
                    { 3, 3, 4, 103400m, new DateTime(2025, 11, 3), "Коммунальные платежи" },
                    { 4, 1, 1, 1200.50m, new DateTime(2025, 11, 5), "Продукты" },
                    { 5, 2, 5, 3500.00m, new DateTime(2025, 11, 10), "Зарплата (доход)" },
                    { 6, 1, 8, 450.00m, new DateTime(2025, 11, 15), "Развлечения" },
                    { 7, 3, 3, 700.00m, new DateTime(2025, 11, 20), "Такси" },
                    { 8, 2, 2, 950.00m, new DateTime(2025, 11, 21), "Кофе" }
                });
        }
        ...
        {
            // Удаляем транзакции
            migrationBuilder.DeleteData(table: "Transactions", keyColumn: "Id", keyValues: new object[] { 1, 2, 3, 4, 5, 6, 7, 8 });

            // Удаляем категории
            migrationBuilder.DeleteData(table: "Categories", keyColumn: "Id", keyValues: new object[] { 1, 2, 3, 4, 5, 6, 7, 8 });
